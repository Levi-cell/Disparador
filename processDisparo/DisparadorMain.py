from processDisparo.SQLfunctions.ConsultFunctions import captura_nome_numero_banco_sql
...
from processDisparo.VarreduraClientes import varre_clientes_com_midia, varre_clientes_sem_midia
